...
/*   Updated: 2026/04/13 19:42:17 by nrobinso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
    ...
    while (1) {
        if ((PIND & (1 << PD2)) == 0) {   // if button pressed (active LOW)
            
            _delay_ms(150);
            
            PORTB ^= (1 << PB0);
            
            while ((PIND & (1 << PD2)) == 0) {   // if button pressed (active LOW)
                _delay_ms(150);    
            }                
        }
        _delay_ms(150);
...
// PORTB is initialised HIGH also
