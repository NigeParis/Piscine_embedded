...
/*   Updated: 2026/04/19 13:39:14 by nrobinso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define SPEED 0                     // Normal 1 / Double speed 0
#define BAUDRATE 115200             // baud Com Speed
#define OSC_SPEED_MHZ 16            // Oscillation Speed page
#define MODE (OSC_SPEED_MHZ / 2)    // p 182 set bit UCSRnA -> NORMAL -> 1 DBL SPEED -> 2
#define MYUBRR (((F_CPU / (MODE * BAUDRATE)) -1) + SPEED)      // p 182   UBRR =  16000000
